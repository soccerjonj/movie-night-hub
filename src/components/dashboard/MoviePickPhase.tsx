          ...
          <div className="flex flex-row items-start gap-3 sm:gap-4 p-3 sm:p-4">
            {userPick.poster_url ? (
              <img
                ...
                alt={userPick.title}
                className="w-20 h-28 sm:w-48 sm:h-auto aspect-[2/3] object-cover rounded-lg shrink-0 self-start"
              />
            ) : (
              <div className="w-20 h-28 sm:w-48 aspect-[2/3] bg-muted rounded-lg flex items-center justify-center shrink-0 self-start">
